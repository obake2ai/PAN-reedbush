...
def train(generator, discriminator, dataloader, opt):
    ...
    saveDir = dateInfo + '_WGAN-GP_' + gName + '_' + dName + '_' + datasetName
    ...
    for epoch in range(opt.n_epochs):
        for i, (imgs, _) in enumerate(dataloader):
            ...
            if i % opt.n_critic == 0:
                ...
                if batches_done / opt.batch_size % opt.log_interval == 0:
                ...
                if batches_done / opt.batch_size % opt.sample_interval == 0:
                    if batches_done == 0:
