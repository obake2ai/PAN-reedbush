...
opt = easydict.EasyDict({
    ...
    'saveDir' : None,
    'resume' : 26300, #0 = train from scratch
    'logIS' : True,
    'loadDir' : '0056:190112_LCGNoiseGenerator2Dv6__LCGNoiseResNet32__imagenet'
})
...
generator = models.LCGNoiseGenerator2Dv6(opt, seed=0)
