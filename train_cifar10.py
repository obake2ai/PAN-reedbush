...
generator = models.NoiseGenerator2Dv6_512(opt)
...
discriminator = naiveresnet.NoiseResNet512(naiveresnet.NoiseBasicBlock, [2,2,2,2,2,2,2], nchannels=3, nfilters=opt.num_filters, nclasses=1, pool=2, level=0.1)
