...
discriminator = naiveresnet.LCGNoiseResNet32(naiveresnet.LCGNoiseBasicBlock, [2,2,2,2], nchannels=3, nfilters=opt.num_filters, nclasses=1, pool=2, level=0.1, seeds=[100, 200, 300])
