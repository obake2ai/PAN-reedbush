...
generator = models.NoiseResGeneratorEcoLongA(opt)
nc = 3
discriminator = naiveresnet.NoiseResNetEco32(naiveresnet.NoiseBasicBlock, [2,2,2,2], nchannels=nc, nfilters=opt.num_filters, nclasses=1, pool=2, level=0.1)
